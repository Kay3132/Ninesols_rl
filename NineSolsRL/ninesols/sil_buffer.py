...
class SILBuffer:
    # v2.0.0: 跟 env.NineSolsEnv.OBS_DIM 同步(17 base + 8 attack_category + 20 attack_id one-hot)
    # rebuilt 2026-06-13: 45 → 56,跟著 env.py 的 +11 新 obs(shield/hazard/attack_nearest)
    OBS_DIM = 56
