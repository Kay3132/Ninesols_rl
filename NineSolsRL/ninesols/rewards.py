...
# 2026-06-15: heal 成功 → 凸型 quadratic,對稱於 hurt(係數同 W_PLAYER_HURT_Q=120)。
# r += W·dphp²:回10% = +1.2,回30% = +10.8,回50% = +30,回80% = +76.8。
...
def compute_reward(prev: dict | None, cur: dict, use_instrumental: bool = True) -> float:
    ...
    if prev is not None:
        ...
        if dphp < 0:
            ...
            # 2026-06-15: heal 成功 → 凸型 quadratic(對稱於 hurt 的 -W_PLAYER_HURT_Q·dphp²)
